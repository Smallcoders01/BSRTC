        ...
        <div className="col-lg-11 col-md-10">
          ...
          <div className="row">
            ...
            <div className="col-md-6 mb-4">
              <div className="card text-white  p-4 h-100 border border-secondary rounded-3 shadow-sm" style={{ backgroundColor: '#6B4190', color: 'white',padding:'400px',fontSize:'14px',letterSpacing:'1.2px' }}>
              ...
              <div className="row">
                {destinations.map((destination, index) => (
                  <div className="col-sm-6 mb-4" key={index}>
                    <div className="card h-100 border-0 shadow-lg position-relative overflow-hidden rounded-3 cardone">
                      <img
                      ...
                      <div className="card-overlay d-flex justify-content-between align-items-end p-3 rounded-3">
                        ...
                        <a href="#" className="btn text-white btn-sm shadow-sm btn2" style={{ backgroundColor: '#7A1CAC' }}>
                          Book Now
                        </a>
                      </div>
                    </div>
